...
namespace Nesne_Tabanlı_Proje
{
    public partial class Form2 : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'kullanicilarborc.borcbilgisi' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.borcbilgisiTableAdapter.Fill(this.kullanicilarborc.borcbilgisi);
            ...
            //Toplu ComboBox Değerleri Belirlendi
            comboBox1.Items.Add("Doğalgaz");
            comboBox1.Items.Add("Elektrik");
            comboBox1.Items.Add("Su");
            comboBox1.Items.Add("Aidat");
            comboBox1.Items.Add("Tamir-Servis");
        ...
        private void kullanicilardatagridview()
        {
        ...
        private void borcsilmedatagridview()
        {
            try
            {
                baglantim.Open();
                SqlDataAdapter adapter = new SqlDataAdapter("Select daireno,ad,soyad,kategori,turar from borcbilgisi", baglantim);
                DataTable dataTable = new DataTable();
                adapter.Fill(dataTable);
        ...
        private void daireyeborcekle_Click(object sender, EventArgs e)
        {
            ...
            while (reader.Read())
            {
                ...
                if (reader["daireno"].ToString() == bedairenoBox.Text)
                {
                    try
                    {
                        SqlCommand kborcekle = new SqlCommand("insert into borcbilgisi(kategori,ad,soyad,tutar,daireno) values (@kategori,@ad,@soyad,@tutar,@daireno)", baglantim);
