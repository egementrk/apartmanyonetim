...
namespace Nesne_Tabanlı_Proje
{
    public partial class Form1 : Form
    {
        ...
        //Public Değişkenler
        public static string  tcno,adi, soyadi, yetki,daireno="";
        ...
        private void girisButton_Click_1(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("Select kullaniciadi,sifre,yetki,tcno,ad,soyad,plakano,borcbilgisi,daireno from kullanicilar", baglantim);
            ...
            while (reader.Read())
            {
                if (yoneticiRadio.Checked == true)
                {
                       ...
                       reader["yetki"].ToString() == "Yönetici")
                    {
                        ...
                        daireno = reader.GetValue(8).ToString();
                        // Form Gizlendi
                        this.Hide();
